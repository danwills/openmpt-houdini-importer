...
Part two is a Houdini Digital Asset ("HDA") with accompanying python module source, that is intended to allow you to 'import' tracker-module music files into Houdini for lots of fun visualising the music! 
